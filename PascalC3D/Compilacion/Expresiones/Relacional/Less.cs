...
namespace PascalC3D.Compilacion.Expresiones.Relacional
{
    class Less : Expresion
    {
        ...
        public Less(bool isLessEqual, Expresion left, Expresion right, int linea, int columna)
        {
        ...
        public Retorno compilar(Entorno ent)
        {
            ...
            switch (left.type.tipo)
            {
                ...
                case Tipos.REAL:
                    ...
                    switch (right.type.tipo)
                    {
                        ...
                        case Tipos.REAL:
                            ...
                            if (this.isLessEqual) generator.addIf(left.getValue(), right.getValue(), "<=", this.trueLabel);
                ...
                case Tipos.BOOLEAN:
                    ...
                    this.trueLabel = this.trueLabel == "" ? generator.newLabel() : this.trueLabel;
                    this.falseLabel = this.falseLabel == "" ? generator.newLabel() : this.falseLabel;
                    if(isLessEqual) generator.addIf(left.getValue(), right.getValue(), "<=", trueLabel);
                ...
                case Tipos.STRING:
                    ...
                    if (right.type.tipo == Tipos.STRING)
                    {
                        ...
                        if(this.isLessEqual) generator.addCall("native_lessEq_str");
                        else generator.addCall("native_less_str");
