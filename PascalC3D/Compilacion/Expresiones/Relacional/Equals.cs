...
namespace PascalC3D.Compilacion.Expresiones.Relacional
{
    class Equals : Expresion
    {
        ...
        public Equals(Expresion left, Expresion right, int linea, int columna)
        {
            this.left = left;
            this.right = right;
            this.linea = linea;
        ...
        public Retorno compilar(Entorno ent)
        {
            ...
            throw new Error("Semántico", "No se puede evaluar una comparacion entre un " + left.type.tipoToString() + " y un " + right.type.tipoToString(), ent.obtenerAmbito(),linea,columna);
        }
    }
}
